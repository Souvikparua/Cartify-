...
public sealed class DealerDbContextFactory : IDesignTimeDbContextFactory<DealerDbContext>
{
    public DealerDbContext CreateDbContext(string[] args)
    {
        ...
        var optionsBuilder = new DbContextOptionsBuilder<DealerDbContext>();
        optionsBuilder.UseSqlServer(connectionString);
        return new DealerDbContext(optionsBuilder.Options);
    }
